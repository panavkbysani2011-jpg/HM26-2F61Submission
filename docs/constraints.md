...
| 2 | Unclear jurisdiction | `✅` | `N/A` |
| 3 | Prioritisation beyond "most votes" | `✅` | `N/A` |
| 4 | Bad input (duplicate, fake photo, wrong location, abuse) | `✅` | `N/A` |
...
- Code: `src/backend/services/routing_engine.py`
